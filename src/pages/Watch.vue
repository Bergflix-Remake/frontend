...
<!-- Watch -->
<div class="flex flex-col justify-center w-full h-full p-10">
    ...
    <div class="w-full p-10 mt-10 rounded-md bg-darker">
        <div class="flex flex-row">
            ...
            <div id="right-items" class="flex flex-row ml-auto text-white h-7">
...
import { get_movie, Movie } from '../api_handler';
...
const movie: Movie = await get_movie(Number(pageid)).then((movie: Movie) => {
    if (movie.id == null) {
        invalidId = true;
    }
    return movie;
